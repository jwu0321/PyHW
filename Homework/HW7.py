...
Implement the function to use a dictionary to turn a string into button presses. 'Hello, World!' becomes
4433555555666110966677755531111. Account for both uppercase and lowercase letters. The button's don't differentiate
for capitalization, you can adjust the input for the table.
"""
...
"""
Problem 3
Create a Car class with the attributes max_speed, current_speed, and brand. Add two methods, accelerate and decelerate,
and add 5 to current_speed in accelerate and subtract 5 in decelerate. Check if accelerating will go past max_speed
